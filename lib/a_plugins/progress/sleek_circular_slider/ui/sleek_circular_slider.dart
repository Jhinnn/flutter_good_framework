...
import 'sleek_circular_slider_demo.dart';
...
final example01 = SleekCircularSliderDemo(
...
final example02 = SleekCircularSliderDemo(
...
final example03 = SleekCircularSliderDemo(
...
final example04 = SleekCircularSliderDemo(
...
final viewModel05 = ExampleViewModel(
    ...
    value: 67459,
    pageColors: [Colors.black, Colors.black87]);
final example05 = SleekCircularSliderDemo(
...
final example06 = SleekCircularSliderDemo(
...
final example07 = SleekCircularSliderDemo(
...
final example08 = SleekCircularSliderDemo(
...
final example09 = SleekCircularSliderDemo(
...
final example10 = SleekCircularSliderDemo(
...
class SleekCircularSilderDemo extends StatefulWidget {
  SleekCircularSilderDemo({Key? key}) : super(key: key);

  _SleekCircularSilderDemoState createState() => _SleekCircularSilderDemoState();
}

class _SleekCircularSilderDemoState extends State<SleekCircularSilderDemo> {
