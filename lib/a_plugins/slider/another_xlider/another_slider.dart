...
class AnotherSliderDemo extends StatefulWidget {
  const AnotherSliderDemo({Key? key}) : super(key: key);

  @override
  _AnotherSliderDemoState createState() => _AnotherSliderDemoState();
}

class _AnotherSliderDemoState extends State<AnotherSliderDemo> {
