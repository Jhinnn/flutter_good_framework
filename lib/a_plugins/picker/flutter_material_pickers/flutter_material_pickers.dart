...
class FlutterMaterialPickers extends StatelessWidget {
  const FlutterMaterialPickers({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return AdaptiveTheme(
      ...
      builder: (context, theme) {
        return const FlutterMaterialPickersPage();
      },
    );
  }
}

class FlutterMaterialPickersPage extends StatefulWidget {
  const FlutterMaterialPickersPage({Key? key}) : super(key: key);

  @override
  _FlutterMaterialPickersPageState createState() =>
      _FlutterMaterialPickersPageState();
}

class _FlutterMaterialPickersPageState
    extends State<FlutterMaterialPickersPage> {
