...
class TouchableScreen2 extends StatefulWidget {
  const TouchableScreen2({Key? key}) : super(key: key);

  @override
  _TouchableScreen2State createState() => _TouchableScreen2State();
}

class _TouchableScreen2State extends State<TouchableScreen2> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    eye = AnimationController(duration: const Duration(seconds: 1), vsync: this);
    nose =
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(title: Text('TouchableScreen3')),
      body: SafeArea(
      child: Column(
