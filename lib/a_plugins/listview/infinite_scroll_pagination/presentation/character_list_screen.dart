...
import 'pull_to_refresh/character_list_view.dart';
import 'search_grid_bloc/character_sliver_grid.dart';
import 'search_snackbar/character_sliver_list.dart';
...
class _CharacterListScreenState extends State<CharacterListScreen> {
  ...
  Widget build(BuildContext context) => Scaffold(
        appBar: AppBar(
          title: const Text('CharacterListScreen'),
        ),
