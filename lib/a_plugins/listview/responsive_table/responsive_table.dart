...
class ResponsiveTableDemo extends StatefulWidget {
  const ResponsiveTableDemo({Key? key}) : super(key: key);
  @override
  _ResponsiveTableDemoState createState() => _ResponsiveTableDemoState();
}

class _ResponsiveTableDemoState extends State<ResponsiveTableDemo> {
