...
class SearchableListviewDemo extends StatefulWidget {
  const SearchableListviewDemo({Key? key}) : super(key: key);

  @override
  State<SearchableListviewDemo> createState() => _SearchableListviewDemoState();
}

class _SearchableListviewDemoState extends State<SearchableListviewDemo> {
