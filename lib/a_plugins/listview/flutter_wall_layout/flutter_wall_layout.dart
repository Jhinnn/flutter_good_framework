...
class FlutterWallLayoutDemo extends StatelessWidget {
  const FlutterWallLayoutDemo({super.key});

  @override
  Widget build(BuildContext context) {
    return MyHomePage(title: 'Wall Layout Demo');
  }
}
  ...
  Widget __buildDirectionOption() {
    return _buildOption(
      ...
      CupertinoSegmentedControl<Axis>(
        ...
        children: {
          Axis.vertical: const Text("vertical"),
          Axis.horizontal: const Text("horizontal")
        },
        onValueChanged: (value) => setState(() {
          _controller.forward(from: 0.0);
          _direction = value;
