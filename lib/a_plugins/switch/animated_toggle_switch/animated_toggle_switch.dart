...
class FlutterToggleSwitchDemo extends StatefulWidget {
  const FlutterToggleSwitchDemo({
    Key? key,
  }) : super(key: key);

  @override
  _FlutterToggleSwitchDemoState createState() =>
      _FlutterToggleSwitchDemoState();
}

class _FlutterToggleSwitchDemoState extends State<FlutterToggleSwitchDemo> {
  int value = 0;
  bool positive = false;
