...
class FlutterSwitchDemo extends StatefulWidget {
  const FlutterSwitchDemo({super.key});

  @override
  _FlutterSwitchDemoState createState() => _FlutterSwitchDemoState();
}

class _FlutterSwitchDemoState extends State<FlutterSwitchDemo> {
  bool status1 = false;
  bool status2 = true;
  bool status3 = false;
  bool status4 = false;
                ...
                Row(
                  ...
                  children: <Widget>[
                    FlutterSwitch(
                      ...
                      inactiveTextColor: Color.fromARGB(255, 182, 210, 231),
                      value: status3,
                      onToggle: (val) {
                        setState(() {
                          status3 = val;
