...
class FlutterAdvancedSegmentDemo extends StatefulWidget {
  const FlutterAdvancedSegmentDemo({Key? key}) : super(key: key);

  @override
  _FlutterAdvancedSegmentDemoState createState() => _FlutterAdvancedSegmentDemoState();
}

class _FlutterAdvancedSegmentDemoState extends State<FlutterAdvancedSegmentDemo> {
  ...
  Widget build(BuildContext context) {
    return LRScaffold(
      title:'flutter_advanced_segment',
